...
public class EventScheduler implements RequestHandler {
    ...
    private Logger logger = Logger.getLogger(EventScheduler.class.getName());

    @Override
    public Boolean handleRequest(Object input, Context context) {

        logger.info("here is event Scheduler");
